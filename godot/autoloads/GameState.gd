...
var player1_stamina: int = 4:
	set(value):
		player1_stamina = clampi(value, 0, max_player_stamina)
		health_changed_player1.emit(player1_stamina, max_player_stamina)
var player2_stamina: int = 4:
	set(value):
		player2_stamina = clampi(value, 0, max_player_stamina)
		health_changed_player2.emit(player2_stamina, max_player_stamina)
